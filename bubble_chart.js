    ...
    function initializeBubbleChart(data) {
        ...
        data = data.filter(function (d) {
            return d.Total_Affected && d.Total_Affected !== "0"; // Check if Total_Affected exists and is not "0"
        });
        ...
        window.filterBubbleChart = function (filters) {
            ...
            filteredroot = d3.hierarchy({ children: filteredDisasterData })
